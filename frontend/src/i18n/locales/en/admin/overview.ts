export default {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        routingGroup: 'Route explicit image requests to group',
        routingGroupNone: 'Do not route; use this group',
        routingGroupEmpty: 'No active OpenAI image groups available',
        routingGroupHint: 'Only explicit image-generation requests use the target group account pool. Normal text requests stay on this group. The target must be active and allow image generation.',
        routingGroupUnavailableSuffix: '(currently unavailable; clear or replace it)',

...
const apiKeyAuthSnapshotVersion = 25 // v25: group image_generation_group_id routing target
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ImageGenerationGroupID:          apiKey.Group.ImageGenerationGroupID,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ImageGenerationGroupID:          snapshot.Group.ImageGenerationGroupID,
